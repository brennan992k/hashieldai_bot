...
export enum DefiWalletKey {
  ...
  updateDefiWalletSeedPhrase = 'dwudwsp',
  updateDefiWalletWallets = 'dwudwws',
...
export enum ProfileKey {
  ...
  updateProfileCards = 'pupcs',
  profileCards = 'ppcs',
  refreshProfileCards = 'prpcs',
...
export enum CallbackDataKey {
  ...
  updateDefiWalletSeedPhrase = DefiWalletKey.updateDefiWalletSeedPhrase,
  updateDefiWalletWallets = DefiWalletKey.updateDefiWalletWallets,
  ...
  updateProfileCards = ProfileKey.updateProfileCards,
  updateCardNumberOfProfile = ProfileKey.updateCardNumberOfProfile,
  updateCardExpDateOfProfile = ProfileKey.updateCardExpDateOfProfile,
  updateCardCVCOfProfile = ProfileKey.updateCardCVCOfProfile,
  profileCards = ProfileKey.profileCards,
  refreshProfileCards = ProfileKey.refreshProfileCards,
